...
<body>
    ...
    <!-- header-end -->
        ...
        <!-- bradcam_area_start -->
        <div class="bradcam_area breadcam_bg overlay2 courses-sky">
            <div class="container">
                <div>
                    <div class="col-md container-fluid">
                        <h1 class="col-md " style="color: #ffffff" align="left">Agregar Usuario</h1>
                    </div>
                    </br>
                    </br>

                    <div class="col-md  row">
                        <label class="form-group col-md-4"><h2 style="color:#ffffff;"> Nombre:</h2></label>
                        <input style="border-radius: 20px" class="form-control col-md-4" type="text" value=""
                               placeholder="Nombre del Libro">
                    </div>
                    </br>
                    <div class="col-md  row">
                        <label class="form-group col-md-4"><h2 style="color:#ffffff;"> Apellido:</h2></label>
                        <input style="border-radius: 20px" class="form-control col-md-4" type="text" value=""
                               placeholder="Nombre del Libro">
                    </div>
                    </br>
                    ...
                    <div class="col-md row">
                        <label  class="form-group col-md-4"><h2 style="color:#ffffff;">Docuemto:</h2></label>
                        <input style="border-radius: 20px" class="form-control col-md-4" type="text" value=""
                               placeholder="Autor del Libro">
                    </div>
                    </br>
                    <div class="col-md row">
                        <label class="form-group col-md-4"><h2 style="color:#ffffff;"> Email:</h2></label>
                        <input style="border-radius: 20px" class="form-control col-md-4" type="text" value=""
                    ...
                    <div class="col-md row">
                        <label class="form-group col-md-4"><h2 style="color:#ffffff;"> Dependencia:</h2></label>
                        <input style="border-radius: 20px" class="form-control col-md-4" type="text" value=""
                               placeholder="Edicionn del Libro">
                    </div>
                    </br>
